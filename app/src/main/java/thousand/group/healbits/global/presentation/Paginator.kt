...
class Paginator<T>(
    private val requestFactory: (Int) -> Single<MutableList<T>>,
    ...
    interface ViewController<T> {
        ...
        fun showData(show: Boolean, data: MutableList<T> = mutableListOf())
    ...
    private interface State<T> {
        ...
        fun loadNewPage() {}
        fun release() {}
        fun newData(data: MutableList<T>) {}
    ...
    private inner class EMPTY_PROGRESS : State<T> {
        ...
        override fun newData(data: MutableList<T>) {
            if (data.isNotEmpty()) {
                currentState = DATA()
                currentData.clear()
